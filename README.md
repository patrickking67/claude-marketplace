...
Add this repository as a marketplace, then install **timekeeper**. The only requirement on any surface is the **Microsoft 365** connector (read) enabled in your workspace — Timekeeper reads Outlook, Teams, calendar, and SharePoint through it.
